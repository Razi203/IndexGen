 ...
 */
#include "LinearCodes.hpp" // Use the new documented header
#include <cassert>
#include <iostream>
#include "GenMat.hpp" // Contains pre-computed generator matrices
#include "GF4.hpp"	  // Contains functions for GF(4) arithmetic (e.g., MatMulGF4)
